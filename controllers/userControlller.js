...
//         const data = await db.query(`INSERT INTO user_data (fname,lname,email,phoneNumber,password,userType) VALUES (?,?,?,?,?,?)`, [fname, lname, email, phoneNumber, hashedPassword, userType])
//         if (!data) {
//             return res.status(404).send({
//                 success: false,
